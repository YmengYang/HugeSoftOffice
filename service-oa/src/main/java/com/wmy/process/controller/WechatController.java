...
import com.wmy.vo.wechat.BindPhoneVo;
...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl, HttpServletRequest request) {
        ...
        String redirectURL = wxMpService.getOAuth2Service().buildAuthorizationUrl(
                userInfoUrl, //第1个参数：授权路径
                WxConsts.OAuth2Scope.SNSAPI_USERINFO, //2.固定值，授权类型
                URLEncoder.encode(returnUrl.replace("guiguoa", "#"))); //3.授权成功后跳转的路径
